    ...
    <div class="border-1 surface-border surface-card border-round py-7 px-4 md:px-7 z-1">
      ...
      <div class="flex flex-column">
                <span class="p-input-icon-left w-full mb-4">
                    ...
                    <InputText id="username" v-model="state.username" type="text" class="w-full md:w-25rem"
                               placeholder="Логин"/>
                </span>
        <span class="p-input-icon-left w-full mb-4">
                    <i class="pi pi-lock"></i>
                    <InputText id="password" type="password" v-model="state.password" class="w-full md:w-25rem"
                               placeholder="Пароль"/>
                </span>
        <div class="mb-4 flex flex-wrap gap-3">
          ...
          <a class="text-600 cursor-pointer hover:text-primary cursor-pointer ml-auto transition-colors transition-duration-300">Забыли
            пароль?</a>
        </div>
        <Button label="Вход" class="w-full mb-4 flex flex-wrap gap-3" @click="login"></Button>
        <div>
          <button class="mb-2 flex flex-wrap p-button p-component w-full gap-3 p-button-info font-medium border-1
                            hover:surface-0 active:surface-200 text-blue-50 hover:text-blue-500"
                  type="button" data-pc-name="button" data-pc-section="root" data-pd-ripple="true">
            ...
            <span role="presentation" aria-hidden="true" data-p-ink="true" data-p-ink-active="false" class="p-ink"
                  ...
                  style="height: 278px; width: 278px; top: -103px; left: -51px;"></span>
          </button>
          <button class="mb-2 flex flex-wrap p-button p-component w-full gap-3 p-button-danger font-medium border-1
                            hover:surface-0 active:surface-200 text-red-50 hover:text-red-500"
                  type="button" data-pc-name="button" data-pc-section="root" data-pd-ripple="true">
          ...
          <button class="mb-2 flex flex-wrap p-button p-component w-full gap-3 surface-900 font-medium border-1
                            hover:surface-200 active:surface-200  hover:text-black-alpha-90"
                  type="button" data-pc-name="button" data-pc-section="root" data-pd-ripple="true">
